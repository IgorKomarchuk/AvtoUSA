...
export default async function AdminPage() {
  await requireAdmin();
  const [dashboard, apiKeys] = await Promise.all([getAdminDashboard(), getApibaraKeySummary()]);
  const activeApiKey = apiKeys.find((item) => item.active);
  const cards = [
