    ...
    <header className="sticky top-0 z-50 border-b border-white/[.07] bg-[#070807]/85 backdrop-blur-2xl">
      <div className="shell flex h-[76px] items-center justify-between gap-4">
        ...
        <div className="hidden items-center gap-2 md:flex">
          <a href="tel:+380732610965" className="premium-focus hidden rounded-lg px-2 text-sm font-bold no-underline lg:block" aria-label="Зателефонувати +38 073 261 09 65">+38 073 261 09 65</a>
      ...
      {open && (
        <div className="border-t border-white/10 bg-[#090a09] px-3 pb-5 pt-3 md:hidden">
          <nav className="mx-auto grid max-w-xl gap-1" aria-label="Мобільна навігація">
            ...
            <a href="tel:+380732610965" className="premium-focus mt-2 flex min-h-12 items-center gap-2 rounded-xl border border-white/10 px-4 py-3 font-bold no-underline" aria-label="Зателефонувати +38 073 261 09 65"><Phone size={16} />+38 073 261 09 65</a>
