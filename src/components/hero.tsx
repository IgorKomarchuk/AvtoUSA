...
export function Hero() {
  return (
    <section className="hero-bright relative min-h-[650px] overflow-hidden border-b border-white/[.08] sm:min-h-[720px] lg:min-h-[760px]">
      ...
      <div className="shell relative z-10 flex min-h-[650px] items-center py-16 sm:min-h-[720px] sm:py-24 lg:min-h-[760px]">
        <div className="max-w-3xl animate-rise">
          <div className="eyebrow">Copart · IAAI · доставка в Україну</div>
          <h1 className="mt-5 max-w-3xl text-[clamp(3.15rem,14vw,4.8rem)] font-[780] leading-[.88] tracking-[-.065em] sm:mt-6 sm:text-[clamp(4.6rem,7.5vw,7.4rem)]">Авто зі США <span className="text-[#ff6b00]">під ключ</span></h1>
