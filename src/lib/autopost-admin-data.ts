...
import { DEFAULT_CHANNEL_CONFIG, DEFAULT_TEMPLATES, SOCIAL_CHANNELS } from "./social-config";
import { channelConfigured, getSocialCredentials } from "./social-credentials";
